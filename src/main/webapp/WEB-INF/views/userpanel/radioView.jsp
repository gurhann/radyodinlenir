...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-8 ">
					...
					<div class="col-sm-8">
						<div class="tabs">
							<div class="tab-heading">${item.name}
								<span class="right"><i class="fa fa-eye"
									aria-hidden="true"></i> ${item.hitCount}</span>
							</div>
			...
			<div class="tabs">
				<div class="tab-heading">
					...
					<sec:authorize access="hasRole('ROLE_USER')">
						...
						<a href="/admin/radios/${item.id}/details" class="right"><i
							class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</a>
			...
			<div class="tabs">
				<div class="tab-heading">
					<i class="fa fa-comments-o" aria-hidden="true"></i> Bizi
					desteklemek için lüften yorum yaparak katkıda bulunun.
				</div>
				<div class="tab-content">
					<div id="fb-root"></div>
					<script>
					...
					<div class="fb-comments" data-href="${currentURL }"
						data-width="690" data-numposts="10"></div>
				</div>
			</div>
			<div class="tabs">
				<div class="tab-heading">
						...
						<c:forEach var="similaradio" items="${similarRadios}">
							<div class="similar-product">
								<figure>
									...
									<figcaption>
										<a href="/station/${similaradio.cleanUrl}"
